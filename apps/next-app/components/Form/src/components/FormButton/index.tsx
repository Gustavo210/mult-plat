...
export function FormButton({ type = 'SUBMIT', disabled, isLoading, onClick, ...props }: FormButtonProps) {
  ...
  return (
    <Button
      ...
      type={type.toLowerCase() as ButtonHTMLAttributes<HTMLButtonElement>['type']}
    />
  )
}
